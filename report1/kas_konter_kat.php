...
<?php
$sql = $koneksi->query("SELECT SUM(masuk) as tot_masuk from transaksi,kategori where id_kategori=uraian and id_kategori='$kategori' and jenis='Masuk' and tgl_transaksi BETWEEN '$dt1' AND '$dt2'");
while ($data = $sql->fetch_assoc()) {
  $masuk = $data['tot_masuk'];
}

$sql = $koneksi->query("SELECT SUM(keluar) as tot_keluar from transaksi,kategori where id_kategori=uraian and id_kategori='$kategori' and jenis='Keluar' and tgl_transaksi BETWEEN '$dt1' AND '$dt2'");
while ($data = $sql->fetch_assoc()) {
      ...
      <table border="1" cellspacing="0">
        ...
        <tbody>
          ...
          if (isset($_POST["btnKat"])) { {
              ...
              $sql_tampil = "SELECT * FROM transaksi,kategori where id_kategori=uraian and id_kategori='$kategori' and tgl_transaksi BETWEEN '$dt1' AND '$dt2' order by id_transaksi desc";
