      ...
      <table border="1" cellspacing="0">
        ...
        <tbody>
          ...
          if (isset($_POST["btnCetak"])) {
            ...
            $sql_tampil = "SELECT * FROM transaksi, kategori where id_kategori=uraian and tgl_transaksi BETWEEN '$dt1' AND '$dt2' order by tgl_transaksi asc";
          }
        ...
        <tr>
          <td colspan="3">Saldo Kas Konter Pulsa</td>
