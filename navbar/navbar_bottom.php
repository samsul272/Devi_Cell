...
<nav class="navbar navbar-dark navbar navbar-expand navbar-default navbar-light fixed-bottom d-md-none d-lg-none d-xl-none p-0">
    <ul class="navbar-nav nav-justified w-100">
        <li class="nav-item <?php if ($hal == 'MyApp/admin') {
                                echo 'active';
                            } ?>">
            <a href="?page=MyApp/admin" class="nav-link text-center">
        ...
        <li class="nav-item <?php if ($hal == 'i_data_k' || $hal == 'i_add_k' || $hal == 'i_edit_k') {
                                echo 'active';
                            } ?>">
            <a href="?page=i_data_k" class="nav-link text-center">
                <svg width="1.5em" height="1.5em" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-grid" viewBox="0 0 16 16">
        ...
        <li class="nav-item dropup <?php if (
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuProfil">
                <a class="dropdown-item <?php if ($hal == 'i_data_km') {
                                            echo 'active';
                                        } ?>" href="?page=i_data_km">Pemasukan</a>
                <a class="dropdown-item <?php if ($hal == 'o_data_km') {
                                            echo 'active';
                                        } ?>" href="?page=o_data_km">Pengeluaran</a>
                <a class="dropdown-item <?php if ($hal == 'rekap_km') {
                                            echo 'active';
                                        } ?>" href="?page=rekap_km">Rekap</a>
            </div>
        </li>
        <li class="nav-item dropup <?php if ($hal == 'MyApp/data_pengguna' || $hal == 'MyApp/profile' || $hal == 'MyApp/about' || $hal == 'lap_pulsa') {
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuProfile">
                <a class="dropdown-item <?php if ($hal == 'MyApp/data_pengguna') {
                                            echo 'active';
                                        } ?>" href="?page=MyApp/data_pengguna">Data User</a>
                <a class="dropdown-item <?php if ($hal == 'MyApp/profile') {
                                            echo 'active';
                                        } ?>" href="?page=MyApp/profile">Profil</a>

                <div class="dropdown-divider"></div>
                <a class="dropdown-item <?php if ($hal == 'lap_pulsa') {
                                            echo 'active';
                                        } ?>" href="?page=lap_pulsa">Print</a>
