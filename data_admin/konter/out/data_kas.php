...
?>
	<div class="alert alert-danger alert-dismissible">
		...
		?>
			...
			<h5>Pengeluaran Hari ini
				...
				$sql = $koneksi->query("SELECT SUM(keluar) as keluar from transaksi where kode_pengguna='$data_id' and jenis='Keluar' and tgl_transaksi BETWEEN '$tgl' and '$tgl2'");
				while ($data = $sql->fetch_assoc()) {
	...
	<div class="card card-info">
		<div class="card-header">
			<h3 class="card-title">
				<i class="fa fa-table"></i> &nbsp;Pengeluaran Konter Pulsa
			</h3>
		</div>
		<!-- /.card-header -->
		<div class="card-body">
			...
			<!------ Form Action ------>
			<form action="?page=o_del_km" method="POST" name="postform" enctype="multipart/form-data">
				<div class="table-responsive">
					...
					<table id="example2" class="table table-bordered table-striped">
						...
						<tbody>
							...
							<?php
							$no = 1;
							$sql = mysqli_query($koneksi, "SELECT * FROM transaksi,kategori where id_kategori=uraian and jenis='keluar' order by id_transaksi desc");
							...
							?>
								...
								<tr>
									...
									<td>
										<a href="?page=o_edit_km&kode=<?php echo $data['id_transaksi']; ?>" title="Ubah" class="btn btn-success btn-sm">
											<i class="fa fa-edit"></i>
										</a>
										<!-- <a href="?page=o_del_km&kode=< echo $data['id_transaksi']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')" title="Hapus" class="btn btn-danger btn-sm">
