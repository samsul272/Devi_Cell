  <div class="card card-secondary">
    ...
    <form action="./report1/kas_konter_kat.php" method="post" enctype="multipart/form-data" target="_blank">
      <div class="card-body">
        ...
        <a href="./report1/kas_konter_full.php" class="btn btn-primary" target="_blank">Cetak Semua</a>
