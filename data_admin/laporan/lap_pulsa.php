  ...
  <div class="row match-height">
    <div class="col-md-6 col-12">
      <div class="card">
        ...
        <div class="card-content">
          <div class="card-body">
            <form action="./report1/kas_konter_kat.php" method="post" class="form form-horizontal">
              <div class="form-body">
                <div class="row">
                  <div class="col-md-4">
    ...
    <div class="col-md-6 col-12">
      <div class="card">
        ...
        <div class="card-content">
          <div class="card-body">
            <form action="./report1/kas_konter_jenis.php" method="post" class="form form-horizontal">
              <div class="form-body">
                <div class="row">
                  <div class="col-md-4">
                    <label>Tanggal Mulai</label>
  ...
  <div class="row match-height">
    <div class="col-md-6 col-12">
      <div class="card">
        ...
        <div class="card-content">
          <div class="card-body">
            <form action="./report1/kas_konter_per.php" method="post" class="form form-horizontal">
              <div class="form-body">
                <div class="row">
                  <div class="col-md-4">
                    <label>Tanggal Mulai</label>
                  ...
                  <div class="col-sm-12 d-flex justify-content-end">
                    ...
                    <a href="./report1/kas_konter_full.php" class="btn btn-danger me-1 mb-1 ml-1" target="_blank"><i class="fa fa-print"></i> Cetak Semua</a>
                  </div>
                </div>
              </div>
            </form>
