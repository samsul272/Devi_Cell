		...
		<form action="" method="post" enctype="multipart/form-data">
			<div class="card-body">
				...
				<div class="form-group row" hidden>
					...
					<div class="col-sm-4">
						<input type="datetime" class="form-control" id="tgl_transaksi" name="tgl_transaksi" value="<?php echo date("Y-m-d H:i:s"); ?>" required readonly />
					</div>
				</div>
			...
			if ($ukuran < 2097152) { // 2 mb = 2097152 byte
				...
				if ($query_simpan) {
				  ...
				  Swal.fire({title: 'Tambah Data Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
					  ...
					  window.location = 'index2.php?page=i_data_kmk';
					  }
				  })</script>";
				} else {
					echo "<script>
				  Swal.fire({title: 'Tambah Data Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
					  ...
					  window.location = 'index2.php?page=i_add_kmk';
					  }
				  })</script>";
				}
			} else {
